...
import { Bell, Clock, Calendar, Users, AlertTriangle, ChevronDown, User, Activity, TrendingUp } from 'lucide-react';
...
const DoctorHeader = ({ user, stats }) => {
  ...
  // Enhanced greeting function with better time ranges and emojis
  const getGreeting = () => {
  ...
  const notificationCount = stats.pendingReviews + (stats.todayAppointments > 0 ? 1 : 0);
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="relative">
            <button 
              ...
              className="relative p-3 bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-600 rounded-xl hover:from-blue-100 hover:to-indigo-100 transition-all duration-200 border border-blue-100 shadow-sm"
            >
              <Bell size={20} />
              {notificationCount > 0 && (
