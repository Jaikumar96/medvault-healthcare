// Enhanced Pagination Component with Smart Ellipsis (Always shows ellipsis after 3 pages)
const Pagination = ({ 
  currentPage, 
  totalPages, 
  onPageChange,
...
// Complete ManageUsers component with the improved pagination
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    {filteredUsers.length === 0 ? (
                        ...
                        <>
                            ...
                            {/* Enhanced Pagination with Smart Ellipsis */}
                            <Pagination
